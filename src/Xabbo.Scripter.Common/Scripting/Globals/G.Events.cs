...
public partial class G
{
    ...
    public void OnInventoryItemUpdated(Action<InventoryItemEventArgs> callback) => Register(_inventoryManager, nameof(_inventoryManager.ItemUpdated), callback);

    public void OnInventoryItemRemoved(Action<InventoryItemEventArgs> callback) => Register(_inventoryManager, nameof(_inventoryManager.ItemRemoved), callback);
